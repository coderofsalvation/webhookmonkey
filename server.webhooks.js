 ...
 **/
var nodepath = "./node_modules/node-red/node_modules/"
var http = require('http');
var https = require('https');
var util = require("util");
var express = require(nodepath+"express");
var crypto = require("crypto");
try { bcrypt = require(nodepath+'bcrypt'); }
catch(e) { bcrypt = require(nodepath+'bcryptjs'); }
var nopt = require(nodepath+"nopt");
var path = require("path");
var fs = require(nodepath+"fs-extra");
...
settings.flowFile = __dirname+"/data/webhooks.json"
...
function basicAuthMiddleware(user,pass) {
    var basicAuth = require(nodepath+'basic-auth');
    var checkPassword;
    if (pass.length == "32") {
